...
interface AddSubfamilyModalProps {
  isOpen: boolean;
  onClose: () => void;
  familyId: string;
  familyName: string;
...
export default function AddSubfamilyModal({
  isOpen,
  onClose,
  familyId,
  familyName,
        ...
        >
          <div>
            ...
            <p style={{ fontSize: '0.875rem', color: '#6B7280', marginTop: '0.25rem' }}>
              Dans la famille: {familyName} ({familyReference})
            </p>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: SUB-001 ou 00001"
              />
          ...
          >
            ...
            >
              ...
              {isLoading ? 'Création...' : 'Créer la Sous-famille'}
            </button>
          </div>
        </form>
      </div>
